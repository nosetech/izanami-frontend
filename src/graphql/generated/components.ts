...
export type GetCurrentUserQuery = { __typename?: 'Query', user?: { __typename?: 'User', id: string, name: string, email: string, role: string, family?: { __typename?: 'Family', id: string, name: string } | null } | null };
